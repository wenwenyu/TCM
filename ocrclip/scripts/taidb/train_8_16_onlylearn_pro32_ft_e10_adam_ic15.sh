...
#CONFIG=${WORKSPACE}/configs/textdet/dbnet/clip_dbnet_r50_fpnc_onlylearn_prompt32_1200e_8x16_ic15_ft_ranger_taiji.py
#CONFIG=${WORKSPACE}/configs/textdet/dbnet/clip_dbnet_r50_fpnc_onlylearn_prompt32_1200e_8x16_ic15_ft_e10_ranger_taiji.py
CONFIG=${WORKSPACE}/configs/textdet/dbnet/clip_dbnet_r50_fpnc_onlylearn_prompt32_1200e_8x16_ic15_ft_e10_adam_taiji.py
#CONFIG=${WORKSPACE}/configs/textdet/dbnet/clip_dbnet_r50_fpnc_onlylearn_prompt32_1200e_8x16_ic15_ft_adam_taiji.py
...
if [ ${GPUS} == 1 ]; then
    python ${WORKSPACE}/train_ocrclip.py  $CONFIG --work-dir=${WORK_DIR}
else
    python -m torch.distributed.launch --nproc_per_node=$GPUS --master_port=$PORT \
        ${WORKSPACE}/train_ocrclip.py $CONFIG --work-dir=${WORK_DIR} --launcher pytorch
fi
