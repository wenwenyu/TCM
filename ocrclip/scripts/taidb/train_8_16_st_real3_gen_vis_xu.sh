...
export WORKSPACE=/apdcephfs/private_mingliangxu/wenwenyu/code/detcp/ocrclip
...
#CONFIG=${WORKSPACE}/configs/textdet/dbnet/clip_db_r50_fpnc_prompt_gen_vis_20e_8x16_st_real3_pretrain_taiji_xu.py
CONFIG=${WORKSPACE}/configs/textdet/dbnet/clip_db_r50_fpnc_prompt_gen_vis_20e_8x16_st_real3_pretrain_taiji_resume_xu.py
python -m torch.distributed.launch --nproc_per_node=8 --master_port=5555 \
${WORKSPACE}/train_ocrclip.py $CONFIG \
--work-dir=/apdcephfs/private_mingliangxu/wenwenyu/model_output/clip_saved/detclip --launcher pytorch