...
#CONFIG=${WORKSPACE}/configs/textdet/dbnet/clip_db_r50_fpnc_prompt_gen_vis_32_20e_8x16_st150k_real3_pretrain_taiji.py
CONFIG=${WORKSPACE}/configs/textdet/dbnet/clip_db_r50_fpnc_prompt_gen_vis_32_20e_8x16_st_st150k_real3_pretrain_taiji.py
