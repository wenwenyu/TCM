...
CONFIG=${WORKSPACE}/configs/textdet/dbnet/clip_dbnet_r50_fpnc_prompt_1200e_8x16_ctw_ft_ranger_taiji.py
#CONFIG=${WORKSPACE}/configs/textdet/dbnet/clip_dbnet_r50_fpnc_prompt_1200e_8x16_ctw_ft_adam_taiji.py

#WORK_DIR=/apdcephfs/share_887471/common/ocr_benchmark/model_output/clip_saved/detclip
WORK_DIR=/apdcephfs/private_v_fisherwyu/model_output/clip_saved/detclip
GPUS=1
PORT=5555
