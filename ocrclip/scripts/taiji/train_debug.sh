...
python ${WORKSPACE}/train_ocrclip.py ${WORKSPACE}/configs/textdet/dbnet/clip_dbnet_r50_fpnc_20e_8x24_st_real3_pretrain_taiji.py \
--work-dir=/apdcephfs/share_887471/common/ocr_benchmark/model_output/clip_saved/detclip