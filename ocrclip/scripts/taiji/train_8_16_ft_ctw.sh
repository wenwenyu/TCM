...
#CHECKPOINT=${WORKSPACE}/configs/textdet/dbnet/clip_dbnet_r50_fpnc_prompt_1200e_8x16_ctw_ft_ranger_taiji.py
#CHECKPOINT=${WORKSPACE}/configs/textdet/dbnet/clip_dbnet_r50_fpnc_nolearn_prompt_1200e_8x16_ctw_ft_ranger_taiji.py
CHECKPOINT=${WORKSPACE}/configs/textdet/dbnet/clip_dbnet_r50_fpnc_prompt_2400e_8x16_ctw_ft_ranger_taiji.py
python -m torch.distributed.launch --nproc_per_node=8 --master_port=5555 \
${WORKSPACE}/train_ocrclip.py  $CHECKPOINT \
--work-dir=/apdcephfs/share_887471/common/ocr_benchmark/model_output/clip_saved/detclip --launcher pytorch