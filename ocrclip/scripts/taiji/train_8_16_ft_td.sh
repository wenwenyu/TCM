...
#CHECKPOINT=${WORKSPACE}/configs/textdet/dbnet/clip_dbnet_r50_fpnc_prompt_1200e_8x16_td_ft_ranger_taiji.py
#CHECKPOINT=${WORKSPACE}/configs/textdet/dbnet/clip_dbnet_r50_fpnc_nolearn_prompt_1200e_8x16_td_ft_ranger_taiji.py
CHECKPOINT=${WORKSPACE}/configs/textdet/dbnet/clip_dbnet_r50_fpnc_prompt_2400e_8x16_td_ft_ranger_taiji.py
