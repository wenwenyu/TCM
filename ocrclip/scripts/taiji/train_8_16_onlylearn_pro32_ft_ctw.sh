...
#CONFIG=${WORKSPACE}/configs/textdet/dbnet/clip_dbnet_r50_fpnc_onlylearn_prompt32_1200e_8x16_ctw_ft_ranger_taiji.py
CONFIG=${WORKSPACE}/configs/textdet/dbnet/clip_dbnet_r50_fpnc_onlylearn_prompt32_1200e_8x16_ctw_ft_adam_taiji.py
