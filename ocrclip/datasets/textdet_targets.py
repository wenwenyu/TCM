...
from mmocr.datasets.pipelines import FCENetTargets


@PIPELINES.register_module()
class FCENetCLIPTargets(FCENetTargets):
    """Generate the ground truth targets of FCENet: Fourier Contour Embedding
    for Arbitrary-Shaped Text Detection.

    adding pix-text matching gt
    ...
    def __init__(self,
                 ...
                 pix_text_match_gt_size_divisors=32,
        ...
        # upldate, append pix-text matching gt
        level_size_divisors_tmp = [x for x in level_size_divisors]
        level_size_divisors_tmp.append(pix_text_match_gt_size_divisors)
        self.level_size_divisors = tuple(level_size_divisors_tmp)

        level_proportion_range_tmp = [x for x in level_proportion_range]
        level_proportion_range_tmp.append((0, 1.0))
        self.level_proportion_range = tuple(level_proportion_range_tmp)
    ...
    def generate_targets(self, results):
        ...
        mapping = {
            ...
            'matching_maps': level_maps[3], # pix-text matching gt
