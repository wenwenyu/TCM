_base_ = [
    ...
    # '../../_base_/det_datasets/ctw1500_taiji_debug.py',
...
data_root = '/apdcephfs/share_887471/common/ocr_benchmark/mmocr_det_data/ctw1500'
...
model = dict(
    ...
    bbox_head=dict(
        type='TextSegHead',
        loss=dict(type='TextSegLoss', loss_weight=2.0, bbce_loss=True),
...
load_from='/apdcephfs/share_887471/common/ocr_benchmark/model_output/clip_saved/detclip/clip_segnet_r50_fpnc_prompt_20e_8x24_st_real3_pretrain_taiji_0306_025751/epoch_5.pth'
...
evaluation = dict(start=0,  by_epoch=True, interval=1, metric='hmean-iou')
