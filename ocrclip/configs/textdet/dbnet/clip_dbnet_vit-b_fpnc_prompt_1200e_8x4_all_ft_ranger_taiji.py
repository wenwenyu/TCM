_base_ = [
    ...
    '../../_base_/det_datasets/ic15_ctw_tt_td_taiji.py',
...
test_pipeline_val_all = {{_base_.test_pipeline_list}}
...
data = dict(
    ...
    val=dict(
        type='PostcfgUniformConcatDataset',
        datasets=test_list,
        pipeline=test_pipeline_val_all,
        separate_postprocessor=True),
    test=dict(
        type='UniformConcatDataset',
        datasets=test_list,
