...
model = dict(
    ...
    bbox_head=dict(
        type='TextSegHead',
        tau=0.07,
        loss=dict(type='TextSegLoss', loss_weight=5.0, bbce_loss=False, with_logits=True),
        postprocessor=dict(type='DBParamPostprocessor', # DBParamPostprocessor  TextSegPostprocessor
                           text_repr_type='poly',
                           mask_thr=0.12, # 0.3
