...
model = dict(
    ...
    bbox_head=dict(
        ...
        postprocessor=dict(type='DBParamPostprocessor',
                           text_repr_type='poly',
                           mask_thr=0.33, # 0.3, 0.1
                           min_text_score=0.53, # 0.3, 0.5, 0.62
                           min_text_width=5,   # 3, 5
                           unclip_ratio=1.9,   # 1.5, 1.7, 2
...
#post_hyper mask_thr: 0.33 min_text_score: 0.53 min_text_width: 5 unclip_ratio: 1.9 ckpt: epoch_250.pth
