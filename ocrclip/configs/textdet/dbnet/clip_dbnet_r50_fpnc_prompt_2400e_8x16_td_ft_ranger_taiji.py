...
model = dict(
    ...
    bbox_head=dict(
        ...
        postprocessor=dict(type='DBParamPostprocessor',
                           text_repr_type='quad',
                           mask_thr=0.08, # 0.3, 0.1
                           min_text_score=0.17, # 0.3, 0.5, 0.6, 0.62
                           min_text_width=5,   # 3, 5
                           unclip_ratio=1.7,   # 1.5, 1.7, 2
...
##post_hyper mask_thr: 0.08 min_text_score: 0.17 min_text_width: 5 unclip_ratio: 1.7 ckpt: epoch_1200.pth
