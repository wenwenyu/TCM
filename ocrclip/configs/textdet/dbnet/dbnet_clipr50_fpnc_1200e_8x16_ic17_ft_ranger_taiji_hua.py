_base_ = [
    ...
    '../../_base_/det_datasets/icdar2017_traval_taiji_hua.py',
...
test_pipeline_4068_1024 = {{_base_.test_pipeline_1024_768}}
...
# load_from = '/apdcephfs/share_887471/interns/v_fisherwyu/model_output/clip_saved/detclip/dbnet_clipr50_fpnc_1200e_8x24_st_real3_pretrain_taiji/epoch_20.pth'
# load_from = '/apdcephfs/share_887471/interns/v_fisherwyu/model_output/clip_saved/detclip/clip_db_r50_fpnc_prompt_gen_vis_20e_8x16_st_real3_pretrain_taiji_resume_xu_0417_032903/epoch_20.pth'
load_from = '/apdcephfs/share_887471/interns/v_willwhua/wenwenyu/model_output/clip_saved/detclip/clip_db_r50_fpnc_prompt_gen_vis_20e_8x16_st_real3_pretrain_taiji_resume_xu_0417_032903/epoch_20.pth'

# optimizer
optimizer = dict(type='Ranger', lr=2e-3, weight_decay=0,
...
evaluation = dict(interval=100, start=1000,
                  metric='hmean-iou',
                  save_best='0_icdar2017_test_hmean-iou:hmean',
                  rule='greater')
log_config = dict(
    interval=10,
    hooks=[
