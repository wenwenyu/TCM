_base_ = [
    ...
    '../../_base_/det_datasets/night_taiji.py',
...
# test_pipeline_4068_1024 = {{_base_.test_pipeline_1333_736}}
...
# prompt_class_names = ['dark night text']
model = dict(
...
# load_from = '/apdcephfs/share_887471/common/ocr_benchmark/model_output/clip_saved/detclip/clip_dbnet_r50_fpnc_1200e_8x16_ic15_ft_adam_taiji_0114_234023/epoch_500.pth'
load_from = '/apdcephfs/share_887471/common/ocr_benchmark/model_output/clip_saved/detclip/clip_dbnet_r50_fpnc_1200e_8x16_ic15_ft_ranger_taiji_0117_214306/epoch_400.pth'
