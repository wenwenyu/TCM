_base_ = [
    ...
    # '../../_base_/det_datasets/ST_real_train_taiji.py',
    # '../../_base_/det_datasets/ST150K_real_train_taiji_xu.py',
    '../../_base_/det_datasets/ST_real_train_taiji_xu.py',
...
resume_from = '/apdcephfs/private_mingliangxu/wenwenyu/model_output/clip_saved/detclip/clip_db_r50_fpnc_prompt_gen_vis_20e_8x16_st_real3_pretrain_taiji_xu_0412_231639/epoch_11.pth'
...
model = dict(
    pretrained='/apdcephfs/private_mingliangxu/wenwenyu/code/detcp/ocrclip/pretrained/RN50.pt',
    # backbone=dict(
...
load_from = '/apdcephfs/private_mingliangxu/wenwenyu/model_output/clip_saved/detclip/clip_db_r50_fpnc_prompt_gen_vis_20e_8x16_st150k_real3_pretrain_taiji_xu_0411_224731/epoch_20.pth'
...
evaluation = dict(interval=21, metric='hmean-iou')
