...
data_root = '/apdcephfs/share_887471/interns/v_willwhua/wenwenyu/data/det_data'
...
train_ann_file2 = f'{data_root}/syntext150k/instances_training.json'
train_img_prefix2 = f'{data_root}/syntext150k'
train2 = {key: value for key, value in train1.items()}
train2['ann_file'] = train_ann_file2
train2['img_prefix'] = train_img_prefix2
train2['data_name'] = 'syntext150k'
