...
train_ann_file_150k = f'{data_root}/syntext150k/instances_training.json'
train_img_prefix_150k = f'{data_root}/syntext150k'
train_150k = {key: value for key, value in train1.items()}
train_150k['ann_file'] = train_ann_file_150k
train_150k['img_prefix'] = train_img_prefix_150k
train_150k['data_name'] = 'syntext150k'


train_mlt17_tra = dict(
    type=icdar_style_clip_dataset_type,
    ann_file=f'{data_root}/icdar2017/instances_training.json',
    img_prefix=f'{data_root}/icdar2017/imgs',
    data_name='icdar2017_train',
    pipeline=None)

train_mlt17_val = dict(
    type=icdar_style_clip_dataset_type,
    ann_file=f'{data_root}/icdar2017/instances_val.json',
    img_prefix=f'{data_root}/icdar2017/imgs',
...
train5_td = dict(
    type=icdar_style_clip_dataset_type,
    ann_file=f'{data_root}/td_tr/instances_td500_train.json',
...
train5_tr = dict(
    type=icdar_style_clip_dataset_type,
    ann_file=f'{data_root}/td_tr/instances_tr400_train.json',
    img_prefix=f'{data_root}/td_tr/tr400',
    data_name='tr400',
    pipeline=None)
...
train_list = [train1, train2, train3, train4, train_150k, train_mlt17_tra, train_mlt17_val, train5_td, train5_tr]
