...
#date
CONFIG=${WORKSPACE}/configs/TESTR/ICDAR15/TESTR_CLIP_R_50_Polygon.yaml

OUT_DIR=/apdcephfs/share_887471/interns/v_fisherwyu/model_output/testr-clip/ctw_onic15
