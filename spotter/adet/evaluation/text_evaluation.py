...
class TESTRTextEvaluator(DatasetEvaluator):
    """
    ...
    def __init__(self, dataset_name, cfg, distributed, output_dir=None):
        ...
        self._lexicon_matcher = LexiconMatcher(dataset_name, cfg.TEST.LEXICON_TYPE, cfg.TEST.USE_LEXICON, 
                                               ...
                                               weighted_ed=cfg.TEST.WEIGHTED_EDIT_DIST, eval_data_root=cfg.DATA_ROOT)
        ...
        if "totaltext" in dataset_name:
            ...
            self._text_eval_gt_path = f"{cfg.DATA_ROOT}/evaluation/gt_icdar2015.zip"
            self._word_spotting = False
        else:
