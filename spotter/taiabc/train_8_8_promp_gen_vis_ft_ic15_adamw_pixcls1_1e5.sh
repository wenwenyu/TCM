...
CONFIG=${WORKSPACE}/configs/BAText/ICDAR15/v1_clip_attn_R_50.yaml
...
SOLVER.IMS_PER_BATCH 1 CLIP.PIX_CLS_LOSS_WEIGHT 1.0 DATALOADER.NUM_WORKERS 0 SOLVER.OPTIMIZER ADAMW \
SOLVER.BASE_LR 0.00001 SOLVER.MAX_ITER 20000 \
TEST.EVAL_PERIOD 20000 SOLVER.CHECKPOINT_PERIOD 1000 \
