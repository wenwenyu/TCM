...
CONFIG=${WORKSPACE}/configs/TESTR/Pretrain/TESTR_R_50_Polygon.yaml
WORK_DIR=/apdcephfs/share_887471/interns/v_fisherwyu/model_output/spotter
OUT_DIR=${WORK_DIR}/pretrain/TESTR_R_50_Polygon_$datename
GPUS=8
PORT=5555
...
python ${WORKSPACE}/tools/train_net.py --config-file $CONFIG --num-gpus $GPUS  --resume OUTPUT_DIR $OUT_DIR \
SOLVER.IMS_PER_BATCH $GPUS CLIP.PIX_CLS_LOSS_WEIGHT 1.0 DATALOADER.NUM_WORKERS 16 SOLVER.OPTIMIZER ADAMW \
