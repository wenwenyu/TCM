...
SOLVER.IMS_PER_BATCH 1 CLIP.PIX_CLS_LOSS_WEIGHT 0.5 DATALOADER.NUM_WORKERS 4 \
SOLVER.MAX_ITER 200000 TEST.EVAL_PERIOD 100 \
MODEL.WEIGHTS /apdcephfs/share_887471/interns/v_fisherwyu/model_output/spotter/pretrain/TESTR_R_50_Polygon_20220428_162132/model_final.pth