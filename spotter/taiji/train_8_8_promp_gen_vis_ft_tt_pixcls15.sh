...
OUT_DIR=${WORK_DIR}/totaltext/TESTR_R_50_Polygon_$datename
GPUS=1
PORT=5555
...
SOLVER.IMS_PER_BATCH 1 CLIP.PIX_CLS_LOSS_WEIGHT 1.5 DATALOADER.NUM_WORKERS 4 \
SOLVER.MAX_ITER 60000 TEST.EVAL_PERIOD 100 \
